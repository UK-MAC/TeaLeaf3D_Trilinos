...
!$      ENDIF
      ...
      IF(tl_use_cg .OR. tl_use_chebyshev .OR. tl_use_ppcg.OR. use_trilinos_kernels) THEN
        ! All 3 of these solvers use the CG kernels, and this is also called for Trilinos to get the initial residual
        IF(use_fortran_kernels) THEN
